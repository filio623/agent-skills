...
> **Dedicated skill available.** For comprehensive Vercel AI SDK documentation, see the upstream [mem0-vercel-ai-sdk skill](https://github.com/mem0ai/mem0/tree/main/skills/mem0-vercel-ai-sdk).
